...
This project is indexed by GitNexus as **ng-chat** (770 symbols, 1409 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
