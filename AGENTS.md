# Don't assume. If you are unsure about what to do, ask for clarification

# Ignore tests for this project
...
- Keep static Tailwind utility classes out of component templates. Use semantic component classes in HTML and place their utilities in the paired `.scss` file with `@apply`; keep only dynamic state or modifier class bindings in templates.
...
This project is indexed by GitNexus as **ng-chat** (1025 symbols, 1864 relationships, 34 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
