...
This project is indexed by GitNexus as **ng-chat** (703 symbols, 1266 relationships, 17 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
