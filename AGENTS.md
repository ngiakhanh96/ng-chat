...
This project is indexed by GitNexus as **ng-chat** (773 symbols, 1418 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
