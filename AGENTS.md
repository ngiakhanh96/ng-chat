...
This project is indexed by GitNexus as **ng-chat** (907 symbols, 1603 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
