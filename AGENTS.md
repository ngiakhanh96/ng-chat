...
This project is indexed by GitNexus as **ng-chat** (724 symbols, 1316 relationships, 18 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
